...
namespace KhachSan.DAO
{
    class ViTriTuyenDung : db
    {
        ...
        public Boolean insertOne(DTO.ViTriTuyenDung vttd)
        {
            try
            {
                BsonArray TGPV = new BsonArray();
                foreach(ObjectId o in vttd.ThamGiaPhongVan) TGPV.Add(o);
        ...
        public Boolean updateOne(DTO.ViTriTuyenDung vttd)
        {
            try
            {
                BsonArray TGPV = new BsonArray();
