    ...
    namespace KhachSan.GUI
    {
        ...
        private void dt_ungvien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.RowIndex < dt_ungvien.Rows.Count - 1)
            {
                ...
                if (e.ColumnIndex == selectedRow.Cells["LinkCV"].ColumnIndex && !string.IsNullOrEmpty(linkCV))
                {
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            var filter = Builders<DTO.ViTriTuyenDung>.Filter.Eq("ThiSinhUngTuyen.MaThiSinh", maThiSinh);

            // Thực hiện xóa ThiSinhUngTuyen từ collection
            collection.UpdateOne(filter, Builders<DTO.ViTriTuyenDung>.Update.PullFilter("ThiSinhUngTuyen", Builders<DTO.ThiSinhUngTuyen>.Filter.Eq("MaThiSinh", maThiSinh)));
        ...
        private void btn_edit_Click(object sender, EventArgs e)
        {
            ...
            var update = Builders<DTO.ViTriTuyenDung>.Update
                ...
                .Set("ThiSinhUngTuyen.$.KyNang", kyNang.Split(',').ToList())
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            String idTS = dt_ungvien.Rows[dt_ungvien.CurrentCell.RowIndex].Cells[0].Value.ToString();
